        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-green-600">for Indian Farmers</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-lg font-semibold hover:bg-green-50 transition-colors flex items-center justify-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Smart agricultural solutions for Indian farmers
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                <p>📞 1800-XXX-XXXX</p>
                <p>📧 support@farmadvisor.in</p>
                <p>🌐 www.farmadvisor.in</p>
              </div>
            </div>
          </div>
          
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Farm Advisor. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
